    ...
    public ReservationDTO createReservation(ReservationDTO reservationDTO) throws Exception {
        try {
            ...
            if (reservationDTO.getMachinery() == null || reservationDTO.getMachinery().getId() == null) {
                throw new Exception("Se requiere maquinaria válida");
            }

            // Consulta optimizada - solo verificar disponibilidad
            boolean isAvailable = machineryRepository.existsByIdAndStatus(
            ...
            // Crear entidad con referencias mínimas
            Reservation reservation = new Reservation();
            reservation.setReservationDate(
                    reservationDTO.getReservationDate() != null ? reservationDTO.getReservationDate() : new Date());
            ...
            machinery.setId(reservationDTO.getMachinery().getId());
