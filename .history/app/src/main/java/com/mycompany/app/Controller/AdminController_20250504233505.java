...
public class AdminController implements ControllerInterface {
    ...
    public ResponseEntity<?> registerAdmin(
        ...
        try {
            ...
            // 2. Registrar Usuario (Admin) - Usando el método dedicado de InventoryService
            UserDTO userDTO = new UserDTO();
            userDTO.setUsername(username);
            userDTO.setPassword(password); // Debe encriptarse
            UserDTO createdUser = inventoryService.createAdmin(userDTO); // Método que ya asigna permisos de admin
