...
public class InventoryService implements UserService, TypeUserService, InventoryS, ReservationService,
    ...
    public MachineryDTO createMachinery(MachineryDTO machineryDTO) throws Exception {
        ...
        // Validación 2: Orden asociada obligatoria
        ...
        // Validación 3: Nombre de máquina obligatorio
        ...
        // Validación 4: Inventario asociado
        ...
        // Validación 5: Estado del inventario
        ...
        // Validación 6: Verificar facturas pagadas para la orden
        ...
        try {
            ...
            MachineryDTO result = Helpers.parse(savedMachinery);
            result.setOrder(order); // Incluir toda la información de la orden
