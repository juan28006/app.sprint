...
public class AdminController implements ControllerInterface {
    ...
    public ResponseEntity<?> registerAdmin(@RequestBody AdminRegistrationRequest request) { // Agregar @Valid
        try {
            ...
            UserDTO createdUser = inventoryService.createAdminU(userDTO);

            AdminDTO adminDTO = new AdminDTO();
            adminDTO.setDepartment(request.getDepartment());
            adminDTO.setId(personDTO.getId()); // Asigna el mismo ID de Person
            AdminDTO createdAdmin = inventoryService.createAdmin(adminDTO); // ← Nuevo método
