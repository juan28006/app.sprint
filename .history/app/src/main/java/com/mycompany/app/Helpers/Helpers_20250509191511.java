...
public abstract class Helpers {
    ...
    public static OrderDTO parse(Order order) {
        ...
        orderDTO.setName_maquina(order.getName_maquina()); // Nuevo campo
    ...
    // Conversión de OrderDTO a Order (actualizado)
    public static Order parse(OrderDTO orderDTO) {
        ...
        order.setName_maquina(orderDTO.getName_maquina()); // Nuevo campo
        order.setCreatedBy(parse(orderDTO.getCreatedBy()));
        order.setInventory(parse(orderDTO.getInventory())); // Nuevo campo
        order.setQuantity(orderDTO.getQuantity());
        order.setUnitPrice(orderDTO.getUnitPrice());
        order.setTotalPrice(orderDTO.getTotalPrice());

        // Nota: No mapeamos las facturas aquí para evitar recursión infinita
        // Las facturas se manejarán en su propio servicio
    ...
    public static ReportInvoicesDTO parse(ReportInvoices report) {
        ...
        // Mapeo simplificado de Order para evitar recursión
        if (report.getOrder() != null) {
            OrderDTO orderDTO = new OrderDTO();
            orderDTO.setId(report.getOrder().getId());
            orderDTO.setOrderNumber(report.getOrder().getOrderNumber());
            orderDTO.setName_maquina(report.getOrder().getName_maquina()); // Asegúrate de incluir el nuevo campo
