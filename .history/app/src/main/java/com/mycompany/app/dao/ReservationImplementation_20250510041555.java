...
public class ReservationImplementation implements ReservationDao {
    ...
    public ReservationDTO createReservation(ReservationDTO reservationDTO) throws Exception {
        ...
        // Crear reserva con relaciones mínimas
        Reservation reservation = new Reservation();
        reservation.setReservationDate(reservationDTO.getReservationDate());
        reservation.setStatus("Pendiente");
        
        // Establecer usuario (solo ID)
        User user = new User();
        user.setId(reservationDTO.getUser().getId());
        reservation.setUser(user);
        
        // Establecer maquinaria (solo ID)
        Machinery machineryRef = new Machinery();
        machineryRef.setId(reservationDTO.getMachinery().getId());
        reservation.setMachinery(machineryRef);

        Reservation savedReservation = reservationRepository.save(reservation);

        // Retornar DTO con datos básicos
        ...
        // Establecer relaciones solo con IDs
