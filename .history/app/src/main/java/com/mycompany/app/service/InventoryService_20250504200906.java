...
public class InventoryService implements UserService, TypeUserService, InventoryS, ReservationService, ReportService,
    ...
    // Método para obtener usuario actual (dependerá de tu implementación de
    // seguridad)
    public UserDTO getCurrentUser() throws Exception {
        // Implementación básica sin Spring Security
    ...
    public UserDTO login(String username, String password) throws Exception {
        ...
        if (!user.isAuthenticated()) {
            throw new Exception("Usuario no está autenticado en el sistema");
        }
        return user;
    }
