...
public class InventoryService implements UserService, TypeUserService, InventoryS, ReservationService, ReportService,
    ...
    @Override
    public UserDTO createAdminU(UserDTO userDTO) throws Exception {
    ...
    public AdminDTO createAdmin(AdminDTO adminDTO) throws Exception {
        if (adminDTO.getId() == null) {
            throw new Exception("El ID de Person es requerido para crear Admin");
        }
        // Asigna automáticamente el tipo de usuario "Admin" si es necesario
        return personDao.createAdmin(adminDTO); // Deberás implementar esto en tu PersonDao
    }
