...
import com.mycompany.app.dto.AdminDTO;
...
import com.mycompany.app.dto.UserPermissionDTO;
...
import com.mycompany.app.model.Permission;
...
import com.mycompany.app.model.UserPermission;
...
public abstract class Helpers {
    ...
    public static AdminDTO parseAdmin(User user, Person person) {
        ...
        dto.setAdminCode(person.getAdminCode());
        dto.setUser(parse(user));

        return dto;
    }

    // EmployeeDTO conversions
    public static EmployeeDTO parseEmployee(User user, Person person) {
        if (user == null || person == null)
            return null;
        ...
        dto.setName(person.getName());
        dto.setCellphone(person.getCellphone());
        dto.setEmployeeId(person.getEmployeeId());
    ...
    // ClientsDTO conversions
    public static ClientsDTO parseClient(User user, Person person) {
        if (user == null || person == null)
            return null;
        ...
        dto.setName(person.getName());
        dto.setCellphone(person.getCellphone());
        dto.setClientCode(person.getClientCode());
