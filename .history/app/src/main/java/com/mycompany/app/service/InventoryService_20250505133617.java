...
public class InventoryService implements UserService, TypeUserService, InventoryS, ReservationService, ReportService,
    ...
    public void deletePerson(PersonDTO personDto) throws Exception {
        ...
        if (!personDao.existsByDocument(personDto.getDocument())) {
            throw new Exception("Persona no encontrada con documento: " + personDto.getDocument());
        }
    ...
    public void deletePerson(PersonDTO personDto) throws Exception {
        ...
        // Verificar si la persona está asociada a algún usuario
        UserDTO associatedUser = userDao.findByPersonDocument(personDto.getDocument());
        if (associatedUser != null) {
            throw new Exception(
                    String.format("No se puede eliminar. La persona está asociada al usuario '%s' (ID: %d)",
    ...
    public PersonDTO getPersonById(Long id) throws Exception {
        ...
        return personDao.findById(id); // Necesitarás implementar este método en PersonDao
    }
}