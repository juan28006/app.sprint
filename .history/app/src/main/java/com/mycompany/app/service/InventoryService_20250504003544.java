...
public class InventoryService implements UserService, TypeUserService, InventoryS, ReservationService, ReportService,
    ...
    public UserDTO createUser(UserDTO userDTO) throws Exception {
        ...
        // Manejo explícito del estado de autenticación
        if(userDTO.getAuthenticated() == null)
            userDTO.setAuthenticated(false); // Valor por defecto
        else if(userDTO.getAuthenticated() == true  )


        // 6. Create and return the user
