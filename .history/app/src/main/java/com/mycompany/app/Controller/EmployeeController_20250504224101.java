...
public class EmployeeController implements ControllerInterface {
    ...
    public ResponseEntity<?> registerEmployee(
        ...
        try {
            ...
            userDTO.setTypeUser(new TypeUserDTO("empleado", "Controlar_acceso,Consultar_disponibilidad"));

            UserDTO createdUser = inventoryService.createUser(userDTO);

            // 3. Opcional: Crear EmployeeDTO si necesitas más datos
            EmployeeDTO employeeDTO = new EmployeeDTO();
            employeeDTO.setUser(Helpers.parse(createdUser)); // Convert UserDTO a User
