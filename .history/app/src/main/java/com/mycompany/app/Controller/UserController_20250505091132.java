...
public class UserController {
    ...
    public ResponseEntity<?> updateUser(@PathVariable Long id,
        ...
        try {
            ...
            // Actualizar solo los campos permitidos (incluyendo 'authenticated')
            existingUser.setUsername(userDTO.getUsername());
            existingUser.setPassword(userDTO.getPassword());
            existingUser.setAuthenticated(userDTO.isAuthenticated()); // ← Actualiza el estado
            ...
            return ResponseEntity.ok(Map.of(
                    ...
                    "authenticated", updatedUser.isAuthenticated())); // ← Incluir en respuesta
